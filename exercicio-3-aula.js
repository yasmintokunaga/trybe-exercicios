...
// const studentMorning = [];

// estudantes.forEach((element) => {
//   if (element.turno === 'Manhã') {
//     studentMorning.push(`${element.nome} ${element.sobrenome}`);
//   }
// });

// console.log(studentMorning);
...
const findStudent = (name, students) => {
  const studentFind = students.find((element) => element.nome = name);
  const arrayNotas = studentFind.materias.map((elemento) => (
